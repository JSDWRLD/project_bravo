...
const ProductListPage = ({ category }) => {
    ...
    const products = [
        { id: 1, name: 'Chess Set', price: 29.99, category: 'boards', img: '/src/assets/games/chess.jpg' },
        { id: 2, name: 'Jigsaw Puzzle', price: 15.99, category: 'puzzles', img: '/src/assets/games/puzzle.jpg' },
        { id: 3, name: 'Super Mario Bros 3', price: 49.99, category: 'retros', img: '/src/assets/games/smb3_1.jpg' },
