...
const Footer = () => {
    return (
        <footer className="bg-black text-gray-400 py-4 text-center text-sm">
             <div className="bg-gray-950 text-gray-400 py-4 border-t border-gray-700">
                <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
                    {/* Footer Links */}
                    <nav className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4 mb-2 md:mb-0">
                        <NavLink to="/contact" className="text-xs sm:text-sm font-retro text-indigo-500 hover:text-indigo-300 transition">
                            Contact
                        </NavLink>
                        <NavLink to="/credits" className="text-xs sm:text-sm font-retro text-indigo-500 hover:text-indigo-300 transition">
                            Credits
                        </NavLink>
                        <NavLink to="/about" className="text-xs sm:text-sm font-retro text-indigo-500 hover:text-indigo-300 transition">
                            About
                        </NavLink>
                    </nav>

                    {/* Branding / Logo */}
                    <div className="flex items-center justify-center text-indigo-500 font-semibold text-lg mb-2 md:mb-0">
                        <img src={logo} alt="Retro Replay Logo" className="h-8 sm:h-10 md:h-12 lg:h-16 w-auto mr-2" />
